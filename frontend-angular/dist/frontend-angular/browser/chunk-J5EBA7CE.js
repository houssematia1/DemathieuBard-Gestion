...
var _c04 = (a0) => ({ exact: a0 });
function MainLayoutComponent_For_21_Conditional_5_Template(rf, ctx) {
  if (rf & 1) {
...
function MainLayoutComponent_For_21_Conditional_6_Template(rf, ctx) {
  if (rf & 1) {
...
function MainLayoutComponent_For_21_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "a", 36)(1, "mat-icon", 37);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "span", 38);
    \u0275\u0275text(4);
    \u0275\u0275elementEnd();
    \u0275\u0275template(5, MainLayoutComponent_For_21_Conditional_5_Template, 2, 1, "span", 39)(6, MainLayoutComponent_For_21_Conditional_6_Template, 2, 0, "span", 40);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const item_r2 = ctx.$implicit;
    \u0275\u0275classProp("disabled", item_r2.disabled);
    \u0275\u0275property("routerLink", item_r2.disabled ? null : item_r2.route)("routerLinkActiveOptions", \u0275\u0275pureFunction1(9, _c04, item_r2.route === "/"))("matTooltip", item_r2.disabled ? "Bient\xF4t disponible" : "");
    \u0275\u0275advance(2);
    ...
    \u0275\u0275advance();
    \u0275\u0275conditional(6, item_r2.disabled ? 6 : -1);
  }
}
var MainLayoutComponent = class _MainLayoutComponent {
  constructor() {
    ...
    this.sidenavOpen = signal(true);
    this.sidenavMode = signal("side");
    this.navItems = [
      { label: "Tableau de bord", icon: "dashboard", route: "/dashboard" },
      { label: "Affaires", icon: "business", route: "/affaires" },
      { label: "Plans", icon: "description", route: "/plans" },
      { label: "Contr\xF4les", icon: "fact_check", route: "/controles" },
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _MainLayoutComponent, selectors: [["app-main-layout"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 69, vars: 11, consts: [["sidenav", ""], ["userMenu", "matMenu"], [1, "layout-container"], [1, "db-sidenav", 3, "mode", "opened"], [1, "sidenav-logo"], [1, "logo-box"], [1, "logo-d"], [1, "logo-b"], [1, "logo-text"], [1, "logo-main"], [1, "logo-sep"], [1, "sidenav-subtitle"], [1, "sidenav-divider"], [1, "sidenav-nav"], ["routerLinkActive", "active", "matTooltipPosition", "right", 1, "nav-item", 3, "routerLink", "routerLinkActiveOptions", "disabled", "matTooltip"], [1, "sidenav-user"], [1, "user-avatar"], [1, "user-info"], [1, "user-name"], [1, "user-role"], [1, "layout-content"], [1, "db-navbar"], ["mat-icon-button", "", 1, "menu-toggle", 3, "click"], [1, "navbar-brand"], [1, "navbar-title"], [1, "spacer"], [1, "navbar-actions"], ["mat-icon-button", "", "matTooltip", "Notifications", "routerLink", "/notifications", "matBadgeColor", "warn", "matBadgeSize", "small", 1, "navbar-icon-btn", 3, "matBadge"], ["mat-button", "", 1, "user-menu-btn", 3, "matMenuTriggerFor"], [1, "navbar-avatar"], [1, "navbar-username"], ["xPosition", "before", 1, "user-dropdown"], [1, "menu-header"], ["mat-menu-item", "", "routerLink", "/profile"], ["mat-menu-item", "", 1, "logout-btn", 3, "click"], [1, "page-content"], ["routerLinkActive", "active", "matTooltipPosition", "right", 1, "nav-item", 3, "routerLink", "routerLinkActiveOptions", "matTooltip"], [1, "nav-icon"], [1, "nav-label"], [1, "nav-badge"], [1, "nav-soon"]], template: function MainLayoutComponent_Template(rf, ctx) {
      if (rf & 1) {
        const _r1 = \u0275\u0275getCurrentView();
        \u0275\u0275elementStart(0, "mat-sidenav-container", 2)(1, "mat-sidenav", 3, 0)(3, "div", 4)(4, "div", 5)(5, "span", 6);
        \u0275\u0275text(6, "D");
        \u0275\u0275elementEnd();
        ...
        \u0275\u0275text(17, "Gestion des Affaires BTP");
        \u0275\u0275elementEnd();
        \u0275\u0275element(18, "mat-divider", 12);
        \u0275\u0275elementStart(19, "nav", 13);
        \u0275\u0275repeaterCreate(20, MainLayoutComponent_For_21_Template, 7, 11, "a", 14, _forTrack0);
        \u0275\u0275elementEnd();
        ...
        \u0275\u0275text(30);
        \u0275\u0275elementEnd()()()();
        \u0275\u0275elementStart(31, "mat-sidenav-content", 20)(32, "mat-toolbar", 21)(33, "button", 22);
        \u0275\u0275listener("click", function MainLayoutComponent_Template_button_click_33_listener() {
          \u0275\u0275restoreView(_r1);
        ...
        \u0275\u0275text(35, "menu");
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(36, "div", 23)(37, "span", 24);
        \u0275\u0275text(38, "Tableau de Bord");
        \u0275\u0275elementEnd()();
        \u0275\u0275element(39, "span", 25);
        \u0275\u0275elementStart(40, "div", 26)(41, "button", 27)(42, "mat-icon");
        \u0275\u0275text(43, "notifications_none");
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(44, "button", 28)(45, "div", 29);
        \u0275\u0275text(46);
        \u0275\u0275elementEnd();
        ...
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(51, "mat-menu", 31, 1)(53, "div", 32)(54, "strong");
        \u0275\u0275text(55);
        \u0275\u0275elementEnd();
        ...
        \u0275\u0275elementStart(59, "button", 33)(60, "mat-icon");
        \u0275\u0275text(61, "person_outline");
        \u0275\u0275elementEnd();
        \u0275\u0275text(62, " Mon profil ");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(63, "button", 34);
        \u0275\u0275listener("click", function MainLayoutComponent_Template_button_click_63_listener() {
          \u0275\u0275restoreView(_r1);
      ...
      if (rf & 2) {
        let tmp_13_0;
        const userMenu_r3 = \u0275\u0275reference(52);
        \u0275\u0275advance();
        \u0275\u0275property("mode", ctx.sidenavMode())("opened", ctx.sidenavOpen());
        \u0275\u0275advance(19);
        ...
        \u0275\u0275advance(11);
        \u0275\u0275property("matBadge", ctx.notifSvc.unreadCount() || null);
        \u0275\u0275advance(3);
