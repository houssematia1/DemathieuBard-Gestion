...
var USER_KEY = "db_user";
var AuthService = class _AuthService {
  constructor() {
    this.http = inject(HttpClient);
    this.router = inject(Router);
    this._currentUser = signal(this.loadUserFromStorage());
    this.currentUser = this._currentUser.asReadonly();
    this.isLoggedIn = computed(() => !!this._currentUser());
    this.userRole = computed(() => this._currentUser()?.role ?? null);
  ...
  /* ── Auth ─────────────────────────────────────────────────── */
  login(payload) {
    return this.http.post(`${environment.apiUrl}/api/auth/login`, payload).pipe(tap((response) => this.saveSession(response)));
  }
  register(payload) {
...
@angular/router/fesm2022/router.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-YXL4TWJQ.js.map
